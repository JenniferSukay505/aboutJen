	...
	<header class="bgimage">
		<div class="container">
			...
			<main class="container">
				<div>
					<h1 class="animated swing">Jennifer Sukay</h1>
						<p class="bio"><b>Biography</b></p>
						<p class="bio"> With a degree in business administration and experience in advertising
